...
class Ui_withdraw_window(object):
    def setupUi(self, withdraw_window):
        ...
        self.label_2.setGeometry(QtCore.QRect(690, 0, 101, 91))
...
"background-color: rgb(85, 170, 255);")
    ...
    def retranslateUi(self, withdraw_window):
        ...
        self.label.setText(_translate("withdraw_window", "Input amount to withdraw"))
        self.input_deposit.setText(_translate("withdraw_window", "₱"))
        self.pushButton.setText(_translate("withdraw_window", "ENTER"))
